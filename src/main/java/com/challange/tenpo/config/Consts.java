...
public class Consts {
    ...
    public static final String TENPO_ENTRY_POINT = "tenpo-entry-point";
    ...
    public static final String CONTACT_NAME = "Martin Andres";
    public static final String CONTACT_URL = "";
    public static final String CONTACT_MAIL = "martinfernandoandres1996@gmail.com";
